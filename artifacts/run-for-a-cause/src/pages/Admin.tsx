...
export default function Admin() {
  ...
  const filtered = registrations.filter((r) => {
    ...
    if (r.secret_code?.toLowerCase().includes(q)) return true;
      ...
      <div className="flex-1 py-12 px-4">
        <div className="max-w-full mx-auto px-4">
          ...
          <div className="relative mb-6">
            ...
            <Input
              placeholder="Search by name, email, or secret code..."
              value={search}
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-gray-100 bg-gray-50 text-xs text-muted-foreground uppercase tracking-wide">
                      <th className="text-left px-4 py-3">BIB</th>
                      <th className="text-left px-4 py-3">Name</th>
                      <th className="text-left px-4 py-3">Email</th>
                      <th className="text-left px-4 py-3">Gender</th>
                      <th className="text-left px-4 py-3">Age</th>
                      <th className="text-left px-4 py-3">Distance</th>
                      <th className="text-left px-4 py-3">Shirt</th>
                      <th className="text-left px-4 py-3">Cost</th>
                      <th className="text-left px-4 py-3">Emergency</th>
                      <th className="text-left px-4 py-3">Secret Code</th>
                      <th className="text-left px-4 py-3">Sponsor</th>
                      <th className="text-left px-4 py-3">School Code</th>
